...
X_train, X_test, Y_train, Y_test = train_test_split(iris_input_dataset, iris_output_dataset, train_size=0.8, test_size=0.2, shuffle=True)
...
layers_architecture = np.array([16, 1])
